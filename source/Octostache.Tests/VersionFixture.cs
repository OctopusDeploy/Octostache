...
namespace Octostache.Tests
{
    public class VersionFixture : BaseFixture
    {
        ...
        [InlineData("1.2.3.4-branch.1",
                       ...
                       "1",
                       "")]
        [InlineData("1.2.3.4-branch.1+meta",
                       "1",
                       "2",
                       "3",
                       "4",
                       ...
                       "1",
                       "meta")]
        [InlineData("v1.2.3.4-branch.1+meta",
                       "1",
                       "2",
                       "3",
                       "4",
        ...
        [InlineData("V1.2.3.4-branch.1+meta",
                       ...
                       "1",
                       "meta")]
        [InlineData("V1.2.3.4-branch.hithere+meta",
                       "1",
                       "2",
                       "3",
                       "4",
        ...
        [InlineData("V1.2.3.4-branch-hithere+meta",
                       ...
                       "hithere",
                       "meta")]
        [InlineData("V1.2.3.4-branch_hithere+meta",
                       "1",
                       "2",
                       "3",
                       "4",
        ...
        [InlineData("19.0.0.Final",
                       ...
                       "",
                       "")]
        [InlineData("284.0.0-debian_component_based",
                       "284",
                       "0",
                       "0",
                       "0",
        ...
        [InlineData("v1.2.3",
                       ...
                       "",
                       "")]
        public void TestVersionMajor(string version,
                                     string major,
                                     string minor,
                                     string patch,
                                     string revision,
