...
namespace Octostache.Templates
{
    static class BuiltInFunctions
    {
        static readonly IDictionary<string, Func<string?, string[], string?>> Extensions = new Dictionary<string, Func<string?, string[], string?>>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "lessthan", NumericComparisonFunctions.LessThan },
            { "lessthanorequal", NumericComparisonFunctions.LessThanOrEqual },
            { "greaterthan", NumericComparisonFunctions.GreaterThan },
            { "greaterthanorequal", NumericComparisonFunctions.GreaterThanOrEqual },
